...
# Ensure custom Python startup hooks don't write to stdout.
# PySpark workers expect daemon metadata on stdout and fail if polluted.
os.environ["HELLO_STARTUP_PTH_SILENT"] = "1"
...
def create_spark_session():
    ...
    try:
        builder = SparkSession.builder \
                    ...
                    .config("spark.executorEnv.HELLO_STARTUP_PTH_SILENT", "1")
    ...
    if spark is None:
        raise RuntimeError("Failed to initialize Spark session. Check dependency resolution and Java gateway logs.")
    return spark
