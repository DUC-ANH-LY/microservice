...
public class ReleaseInventoryCommand {
  ...
  public ReleaseInventoryCommand(UUID sagaId, String orderId, UUID correlationId) {
    this(sagaId, orderId, correlationId, null);
  }

  public ReleaseInventoryCommand(UUID sagaId, String orderId, UUID correlationId, FailAt failAt) {
    this.sagaId = sagaId;
