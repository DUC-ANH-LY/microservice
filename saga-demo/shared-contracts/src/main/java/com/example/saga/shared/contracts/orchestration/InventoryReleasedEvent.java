...
public class InventoryReleasedEvent {
  ...
  public InventoryReleasedEvent(UUID sagaId, String orderId, UUID correlationId) {
    this(sagaId, orderId, correlationId, null);
  }

  public InventoryReleasedEvent(UUID sagaId, String orderId, UUID correlationId, FailAt failAt) {
    this.sagaId = sagaId;
