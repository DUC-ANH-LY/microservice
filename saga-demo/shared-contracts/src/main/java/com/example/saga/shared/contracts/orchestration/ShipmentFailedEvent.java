...
public class ShipmentFailedEvent {
  ...
  public ShipmentFailedEvent(UUID sagaId, String orderId, UUID correlationId, String error) {
    this(sagaId, orderId, correlationId, error, null);
  }

  public ShipmentFailedEvent(UUID sagaId, String orderId, UUID correlationId, String error, FailAt failAt) {
    this.sagaId = sagaId;
