...
public class PaymentFailedEvent {
  ...
  public PaymentFailedEvent(UUID sagaId, String orderId, UUID correlationId, String error) {
    this(sagaId, orderId, correlationId, error, null);
  }

  public PaymentFailedEvent(UUID sagaId, String orderId, UUID correlationId, String error, FailAt failAt) {
    this.sagaId = sagaId;
