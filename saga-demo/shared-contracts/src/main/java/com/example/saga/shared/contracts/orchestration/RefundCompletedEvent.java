...
public class RefundCompletedEvent {
  ...
  public RefundCompletedEvent(UUID sagaId, String orderId, UUID correlationId) {
    this(sagaId, orderId, correlationId, null);
  }

  public RefundCompletedEvent(UUID sagaId, String orderId, UUID correlationId, FailAt failAt) {
    this.sagaId = sagaId;
