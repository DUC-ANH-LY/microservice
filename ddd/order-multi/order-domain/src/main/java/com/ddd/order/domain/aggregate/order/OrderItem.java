...
import com.ddd.order.shared.annotation.Entity;
import lombok.Getter;

/**
 * Entity representing a line item within the Order aggregate.
 * Only accessible through the Order aggregate root.
 */
@Entity
@Getter
public class OrderItem {
    ...
    public OrderItem(String productId, String productName, int quantity, Money unitPrice) {
        if (productId == null || productId.isBlank()) throw new IllegalArgumentException("Product ID cannot be blank");
